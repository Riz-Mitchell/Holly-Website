    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 animate-rise">
          ...
          <h1 className="font-display text-[10vw] lg:text-[6vw] leading-[0.88] tracking-tight">
            Build a<br />
            business that
            <br />
            <em className="text-brand">matters.</em>
          </h1>
          <p className="mt-10 max-w-xl text-base lg:text-lg text-foreground/70 leading-relaxed">
