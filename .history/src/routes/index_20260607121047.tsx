    ...
    >
      <div className="mx-auto max-w-5xl px-6 lg:px-10 text-center">
        ...
        <a
          ...
          className="inline-block mt-12 bg-foreground text-background px-10 py-5 text-sm uppercase tracking-[0.18em] hover:bg-background hover:opacity-90 transition-transform"
        >
