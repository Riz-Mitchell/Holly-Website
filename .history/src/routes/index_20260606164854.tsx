    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-foreground/10 backdrop-blur-md bg-background/70">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 h-16 flex items-center justify-between">
        <a href="#top" className="font-display text-xl tracking-tight">
          Holly <span className="text-brand">Winkels</span>
        </a>
        ...
        <a
          href="#contact"
          className="text-xs uppercase tracking-[0.18em] px-4 py-2 bg-brand text-brand-foreground hover:opacity-90 transition"
        >
          Let's Talk
        </a>
      </div>
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 animate-rise">
          ...
          <h1 className="font-display text-[14vw] lg:text-[8.5vw] leading-[0.88] tracking-tight">
            Build a<br />
            business that
            <br />
            <em className="text-brand">matters.</em>
          </h1>
          <p className="mt-10 max-w-xl text-lg text-foreground/70 leading-relaxed">
        ...
        <div className="lg:col-span-5 relative">
          ...
          <div className="absolute -bottom-6 -left-6 bg-brand text-brand-foreground px-5 py-3 text-xs uppercase tracking-[0.18em] rotate-[-3deg]">
            Est. since the first no.
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="border-y border-foreground/10 py-6 overflow-hidden">
      <div className="flex whitespace-nowrap animate-marquee">
        {[...items, ...items].map((item, i) => (
          <span
            key={i}
            className="font-display text-2xl px-8 text-foreground/70"
          >
            {item}
          </span>
        ))}
...
function WorkWithMe() {
  ...
  return (
    <section id="work" className="py-28 lg:py-40 border-t border-foreground/10">
...
function Testimonials() {
  ...
  return (
    <section
      id="testimonials"
      className="py-28 lg:py-40 border-t border-foreground/10"
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <p className="text-xs uppercase tracking-[0.3em] text-brand mb-6">
          — Stories
...
function CTA() {
  return (
    <section
      id="contact"
      className="py-32 lg:py-48 bg-brand text-brand-foreground"
    >
      <div className="mx-auto max-w-5xl px-6 lg:px-10 text-center">
        ...
        <a
          href="mailto:hello@hollywinkels.com"
          className="inline-block mt-12 bg-foreground text-background px-10 py-5 text-sm uppercase tracking-[0.18em] hover:bg-background hover:text-foreground transition"
        >
          hello@hollywinkels.com
        </a>
      </div>
    </section>
  );
